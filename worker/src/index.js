...
<section id="login" class="card"><div class="title">\u0648\u0631\u0648\u062f \u0628\u0647 \u0627\u0628\u0632\u0627\u0631 \u0627\u0635\u0644\u06cc</div><div class="label">ADMIN TOKEN</div><input id="token" class="field" type="password" autocomplete="off" placeholder="\u062a\u0648\u06a9\u0646 \u0645\u062f\u06cc\u0631 \u0631\u0627 \u0648\u0627\u0631\u062f \u06a9\u0646\u06cc\u062f"><div class="row" style="margin-top:10px"><button class="btn primary" onclick="login()">\u0648\u0631\u0648\u062f \u0628\u0647 \u062f\u0627\u0634\u0628\u0648\u0631\u062f</button><button class="btn secondary" onclick="toggleToken()">\u0646\u0645\u0627\u06cc\u0634 \u0631\u0645\u0632</button></div><div id="loginStatus" class="status"></div></section>
...
async function login(){const s=document.getElementById('loginStatus');token=document.getElementById('token').value.trim();if(!token){s.className='status error';s.textContent='ADMIN TOKEN \u0631\u0627 \u0648\u0627\u0631\u062f \u06a9\u0646\u06cc\u062f.';return}s.className='status';s.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0628\u0631\u0631\u0633\u06cc\u2026';try{await api('/api/content');document.getElementById('login').classList.add('hidden');document.getElementById('app').classList.remove('hidden');document.getElementById('logoutBtn').classList.remove('hidden');document.getElementById('nav').classList.remove('hidden');s.textContent='';await loadApprovals();await loadApproved();await loadLeadOverview()}catch(e){token='';s.className='status error';s.textContent=e.message||'\u0648\u0631\u0648\u062f \u0646\u0627\u0645\u0648\u0641\u0642'}}
