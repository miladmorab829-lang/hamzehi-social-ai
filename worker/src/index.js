...
async function shareTelegramMedia(id){try{const r=await fetch('/api/telegram/media/file?id='+encodeURIComponent(id),{headers:headers(),cache:'no-store'});if(!r.ok)throw Error('\u062f\u0631\u06cc\u0627\u0641\u062a \u0631\u0633\u0627\u0646\u0647 \u0646\u0627\u0645\u0648\u0641\u0642 \u0628\u0648\u062f');const blob=await r.blob();const type=blob.type||'application/octet-stream';const ext=type.includes('video')?'mp4':type.includes('png')?'png':'jpg';const file=new File([blob],'HAMZEHI-BOX-Story.'+ext,{type});if(navigator.share&&(!navigator.canShare||navigator.canShare({files:[file]}))){await navigator.share({files:[file],title:'HAMZEHI BOX'});return}const url=URL.createObjectURL(blob);const a=document.createElement('a');a.href=url;a.download=file.name;a.click();setTimeout(()=>URL.revokeObjectURL(url),60000)}catch(e){if(e&&e.name==='AbortError')return;alert('\u062e\u0637\u0627: '+e.message)}}
async function loadWhatsappStory(){const st=document.getElementById('whatsappStoryStatus'),list=document.getElementById('whatsappStoryList');if(!st||!list)return;st.textContent='\u062f\u0631 \u062d\u0627\u0644 \u062f\u0631\u06cc\u0627\u0641\u062a \u0631\u0633\u0627\u0646\u0647\u200c\u0647\u0627\u2026';try{const d=await api('/api/telegram/media?limit=12');const a=d.items||[];st.className='status ok';st.textContent=a.length+' \u0631\u0633\u0627\u0646\u0647 \u0622\u0645\u0627\u062f\u0647 \u0627\u0633\u062a';list.innerHTML=a.length?a.map(x=>'<div class=\"item\"><div class=\"itemhead\"><b>\u{1f4f1} '+esc(x.media_type)+'</b><span class=\"pill\">'+esc(x.created_at||'')+'</span></div><div class=\"mini\">'+esc(x.caption||'\u0628\u062f\u0648\u0646 \u06a9\u067e\u0634\u0646')+'</div><div class=\"actions\" style=\"margin-top:10px\"><button class=\"btn primary\" onclick=\"shareTelegramMedia(&quot;'+esc(x.id)+'&quot;)\">\u0627\u0631\u0633\u0627\u0644 \u0628\u0647 WhatsApp / \u062f\u0627\u0646\u0644\u0648\u062f</button></div></div>').join(''):'<div class=\"empty\">\u0647\u0646\u0648\u0632 \u0631\u0633\u0627\u0646\u0647\u200c\u0627\u06cc \u0627\u0632 \u06a9\u0627\u0646\u0627\u0644 \u062f\u0631\u06cc\u0627\u0641\u062a \u0646\u0634\u062f\u0647 \u0627\u0633\u062a.</div>'}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}}
async function loadTelegramMedia(){const st=document.getElementById('telegramMediaStatus'),list=document.getElementById('telegramMediaList');if(!st||!list)return;st.textContent='\u062f\u0631 \u062d\u0627\u0644 \u062f\u0631\u06cc\u0627\u0641\u062a \u0631\u0633\u0627\u0646\u0647\u200c\u0647\u0627\u06cc \u062c\u062f\u06cc\u062f \u06a9\u0627\u0646\u0627\u0644\u2026';try{const d=await api('/api/telegram/media?limit=12');const a=d.items||[];st.className='status ok';st.textContent=a.length+' \u0631\u0633\u0627\u0646\u0647 \u062f\u0631\u06cc\u0627\u0641\u062a \u0634\u062f';list.innerHTML=a.length?a.map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.media_type)+'</b><span class="pill">'+esc(x.created_at||'')+'</span></div><div class="mini">'+esc(x.caption||'\u0628\u062f\u0648\u0646 \u06a9\u067e\u0634\u0646')+'</div><div class="actions" style="margin-top:10px"><button class="btn secondary" onclick="downloadTelegramMedia(&quot;'+esc(x.id)+'&quot;)">\u0645\u0634\u0627\u0647\u062f\u0647 / \u062f\u0631\u06cc\u0627\u0641\u062a</button></div></div>').join(''):'<div class="empty">\u0647\u0646\u0648\u0632 \u0631\u0633\u0627\u0646\u0647 \u062c\u062f\u06cc\u062f\u06cc \u0627\u0632 \u06a9\u0627\u0646\u0627\u0644 \u062f\u0631\u06cc\u0627\u0641\u062a \u0646\u0634\u062f\u0647. \u0628\u0639\u062f \u0627\u0632 \u0641\u0639\u0627\u0644\u200c\u0633\u0627\u0632\u06cc\u060c \u067e\u0633\u062a\u200c\u0647\u0627\u06cc \u062c\u062f\u06cc\u062f \u06a9\u0627\u0646\u0627\u0644 \u0627\u06cc\u0646\u062c\u0627 \u0645\u06cc\u200c\u0622\u06cc\u0646\u062f.</div>'}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}}
async function setupTelegramMedia(){const st=document.getElementById('telegramMediaStatus');st.className='status';st.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0641\u0639\u0627\u0644\u200c\u0633\u0627\u0632\u06cc \u062f\u0631\u06cc\u0627\u0641\u062a \u0631\u0633\u0627\u0646\u0647\u2026';try{await api('/api/telegram/webhook/setup',{method:'POST'});st.className='status ok';st.textContent='\u062f\u0631\u06cc\u0627\u0641\u062a \u0631\u0633\u0627\u0646\u0647 \u0641\u0639\u0627\u0644 \u0634\u062f. \u062d\u0627\u0644\u0627 \u067e\u0633\u062a\u200c\u0647\u0627\u06cc \u062c\u062f\u06cc\u062f \u06a9\u0627\u0646\u0627\u0644 \u0648\u0627\u0631\u062f \u067e\u0646\u0644 \u0645\u06cc\u200c\u0634\u0648\u0646\u062f.';await loadTelegramMedia()}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}}
...
async function autoAdCampaign(){const st=document.getElementById('adsStatus'),list=document.getElementById('adsList');if(!st||!list)return;const city=document.getElementById('adsCity').value.trim(),extra=document.getElementById('adsExtra').value.trim();st.className='status';st.textContent='\u{1f916} \u0633\u06cc\u0633\u062a\u0645 \u062e\u0648\u062f\u06a9\u0627\u0631 \u062f\u0631 \u062d\u0627\u0644 \u067e\u06cc\u062f\u0627 \u06a9\u0631\u062f\u0646 \u0645\u0634\u062a\u0631\u06cc\u060c \u0645\u062d\u0644 \u062a\u0628\u0644\u06cc\u063a \u0648 \u0622\u0645\u0627\u062f\u0647\u200c\u0633\u0627\u0632\u06cc \u0645\u0630\u0627\u06a9\u0631\u0647 \u0627\u0633\u062a\u2026';list.innerHTML='';try{const d=await api('/api/ads/auto-run',{method:'POST',body:JSON.stringify({city,type:document.getElementById('adsType').value,extra,source_site:'https://www.hamzehibox.com'})});const a=d.items||[];st.className='status ok';st.textContent='\u2705 \u0627\u0646\u062c\u0627\u0645 \u0634\u062f: '+(d.found||0)+' \u0647\u062f\u0641 \u067e\u06cc\u062f\u0627 \u0634\u062f \u00b7 '+(d.drafted||0)+' \u0645\u0630\u0627\u06a9\u0631\u0647 \u0622\u0645\u0627\u062f\u0647 \u0634\u062f \u0648 \u062f\u0631 CRM \u062b\u0628\u062a \u0634\u062f.';list.innerHTML=a.length?a.map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'\u0628\u062f\u0648\u0646 \u0646\u0627\u0645')+'</b><span class="pill">Score '+esc(x.score||0)+'</span></div><div class="mini">'+esc(x.type||'')+' \u00b7 '+esc(x.url||'')+'</div>'+(x.contact_url?'<div class="mini">\u0645\u0633\u06cc\u0631 \u062a\u0645\u0627\u0633/\u062a\u0628\u0644\u06cc\u063a: '+esc(x.contact_url)+'</div>':'')+(x.draft?'<div class="text" style="margin-top:6px">'+esc(x.draft)+'</div>':'')+'</div>').join(''):'<div class="empty">\u0645\u0648\u0631\u062f\u06cc \u067e\u06cc\u062f\u0627 \u0646\u0634\u062f.</div>';loadAdTargets()}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}};

async function discoverAdCustomers(){const st=document.getElementById('adsStatus'),list=document.getElementById('adsList');if(!st||!list)return;const city=document.getElementById('adsCity').value.trim(),type=document.getElementById('adsType').value,extra=document.getElementById('adsExtra').value.trim();st.className='status';st.textContent='\u062f\u0631 \u062d\u0627\u0644 \u067e\u06cc\u062f\u0627 \u06a9\u0631\u062f\u0646 \u0645\u0634\u062a\u0631\u06cc \u0648 \u0645\u062d\u0644 \u062a\u0628\u0644\u06cc\u063a\u2026';list.innerHTML='';try{const d=await api('/api/ads/discover',{method:'POST',body:JSON.stringify({city,type,extra,source_site:'https://www.hamzehibox.com'})});const a=d.items||[];st.className='status ok';st.textContent='\u067e\u06cc\u062f\u0627 \u0634\u062f: '+a.length+' \u0645\u0648\u0631\u062f \u00b7 \u0645\u0634\u062a\u0631\u06cc \u0648 \u0645\u0633\u06cc\u0631 \u062a\u0628\u0644\u06cc\u063a\u0627\u062a \u062f\u0631 CRM \u0630\u062e\u06cc\u0631\u0647 \u0634\u062f.';list.innerHTML=a.length?a.map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'\u0628\u062f\u0648\u0646 \u0646\u0627\u0645')+'</b><span class="pill">Score '+esc(x.score||0)+'</span></div><div class="mini">'+esc(x.kind||'')+' \u00b7 '+esc(x.city||'')+'</div><div class="mini">'+esc(x.url||'')+'</div><div class="text" style="margin-top:6px">'+esc(x.evidence||'')+'</div><div class="actions" style="margin-top:10px"><button class="btn secondary" onclick="makeAdNegotiationDraft(&quot;'+esc(x.id)+'&quot;)">\u270d\ufe0f \u0622\u0645\u0627\u062f\u0647\u200c\u0633\u0627\u0632\u06cc \u0645\u0630\u0627\u06a9\u0631\u0647</button>'+(x.contact_url?'<button class="btn secondary" onclick="window.open(&quot;'+esc(x.contact_url)+'&quot;,&quot;_blank&quot;)">\u0631\u0627\u0647 \u062a\u0645\u0627\u0633</button>':'')+'</div><div id="ad-draft-'+esc(x.id)+'" class="status"></div></div>').join(''):'<div class="empty">\u0645\u0648\u0631\u062f\u06cc \u067e\u06cc\u062f\u0627 \u0646\u0634\u062f.</div>'}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}}
async function makeAdNegotiationDraft(id){const box=document.getElementById('ad-draft-'+String(id));if(box){box.className='status';box.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0622\u0645\u0627\u062f\u0647\u200c\u0633\u0627\u0632\u06cc \u067e\u06cc\u0634\u0646\u0647\u0627\u062f \u0645\u0630\u0627\u06a9\u0631\u0647\u2026'}try{const d=await api('/api/ads/negotiation-draft',{method:'POST',body:JSON.stringify({lead_id:id})});if(box){box.className='status ok';box.innerHTML='<div class="text">'+esc(d.draft||'')+'</div><div class="mini" style="margin-top:6px">\u0627\u0631\u0633\u0627\u0644/\u062b\u0628\u062a \u0646\u0647\u0627\u06cc\u06cc \u0646\u06cc\u0627\u0632 \u0628\u0647 \u062a\u0623\u06cc\u06cc\u062f \u062f\u0633\u062a\u06cc \u062f\u0627\u0631\u062f.</div>'}}catch(e){if(box){box.className='status error';box.textContent='\u062e\u0637\u0627: '+e.message}}}
async function loadAdTargets(){const st=document.getElementById('adsSavedStatus'),list=document.getElementById('adsSavedList');if(!st||!list)return;try{const d=await api('/api/ads/targets');const a=d.items||[];st.className='status ok';st.textContent=a.length+' \u0647\u062f\u0641 \u062a\u0628\u0644\u06cc\u063a\u0627\u062a\u06cc/\u0645\u0634\u062a\u0631\u06cc \u0630\u062e\u06cc\u0631\u0647 \u0634\u062f\u0647';list.innerHTML=a.length?a.map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'')+'</b><span class="pill">'+esc(x.stage||'discovered')+'</span></div><div class="mini">'+esc(x.contact||'')+'</div></div>').join(''):'<div class="empty">\u0647\u0646\u0648\u0632 \u0647\u062f\u0641\u06cc \u0630\u062e\u06cc\u0631\u0647 \u0646\u0634\u062f\u0647.</div>'}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}}
async function loadAdOverview(){const b=document.getElementById('adOverviewBody');if(!b)return;try{const d=await api('/api/ads/overview'),m=d.metrics||{};b.innerHTML='<div class="two"><div><div class="stat">'+esc(m.found_today||0)+'</div><div class="muted">\u0641\u0639\u0627\u0644\u06cc\u062a \u0627\u0645\u0631\u0648\u0632</div></div><div><div class="stat">'+esc(m.hot||0)+'</div><div class="muted">\u0644\u06cc\u062f \u062f\u0627\u063a</div></div><div><div class="stat">'+esc(m.negotiation||0)+'</div><div class="muted">\u0645\u0630\u0627\u06a9\u0631\u0647</div></div><div><div class="stat">'+esc(m.due_followups||0)+'</div><div class="muted">\u067e\u06cc\u06af\u06cc\u0631\u06cc \u0633\u0631\u0631\u0633\u06cc\u062f</div></div></div><div class="mini" style="margin-top:10px">'+esc(m.ad_opportunities||0)+' \u0641\u0631\u0635\u062a \u062a\u0628\u0644\u06cc\u063a\u0627\u062a\u06cc \u00b7 '+esc(m.customers||0)+' \u0645\u0634\u062a\u0631\u06cc \u00b7 '+esc(m.ad_targets||0)+' \u0647\u062f\u0641 \u062a\u0628\u0644\u06cc\u063a\u0627\u062a\u06cc</div>';b.className='status ok';const list=document.getElementById('adOpportunityList');if(list)list.innerHTML=(d.items||[]).map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'\u0628\u062f\u0648\u0646 \u0646\u0627\u0645')+'</b><span class="pill">Score '+esc(x.score||0)+'</span></div><div class="mini">'+esc(x.type||'')+' \u00b7 '+esc(x.stage||'')+'</div>'+(x.ad_opportunity?'<div class="mini">\u0641\u0631\u0635\u062a \u062a\u0628\u0644\u06cc\u063a\u0627\u062a\u06cc \u0634\u0646\u0627\u0633\u0627\u06cc\u06cc \u0634\u062f</div>':'')+(x.contact_url?'<div class="actions" style="margin-top:8px"><button class="btn secondary" onclick="window.open(&quot;'+esc(x.contact_url)+'&quot;,&quot;_blank&quot;)">\u0645\u0633\u06cc\u0631 \u062a\u0645\u0627\u0633</button></div>':'')+'</div>').join('')||'<div class="empty">\u0647\u0646\u0648\u0632 \u0641\u0631\u0635\u062a \u062a\u0628\u0644\u06cc\u063a\u0627\u062a\u06cc \u062b\u0628\u062a \u0646\u0634\u062f\u0647.</div>'}catch(e){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}
async function loadAdActionCenter(){const b=document.getElementById('adActionCenter');if(!b)return;b.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0622\u0645\u0627\u062f\u0647\u200c\u0633\u0627\u0632\u06cc \u0627\u0642\u062f\u0627\u0645\u200c\u0647\u0627\u2026';try{const d=await api('/api/ads/action-center'),c=d.counts||{};const labels={today:'\u067e\u06cc\u06af\u06cc\u0631\u06cc \u0627\u0645\u0631\u0648\u0632',urgent:'\u0627\u0642\u062f\u0627\u0645 \u0641\u0648\u0631\u06cc',opportunity:'\u0641\u0631\u0635\u062a \u062a\u0628\u0644\u06cc\u063a'};b.innerHTML='<div class="two">'+Object.entries(labels).map(([k,v])=>'<div><div class="stat">'+esc(c[k]||0)+'</div><div class="muted">'+v+'</div></div>').join('')+'</div>'+(d.items||[]).map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'\u0628\u062f\u0648\u0646 \u0646\u0627\u0645')+'</b><span class="pill">'+esc(String(x.score||0))+'</span></div><div class="mini">'+esc(labels[x.bucket]||'\u0628\u0631\u0631\u0633\u06cc')+' \u00b7 '+esc(x.stage||'')+'</div><div class="mini">'+esc(x.action||'')+'</div><div class="mini">'+esc((x.factors||[]).join(' \u00b7 '))+'</div></div>').join('')||'<div class="empty">\u0641\u0639\u0644\u0627\u064b \u0627\u0642\u062f\u0627\u0645 \u0645\u0634\u062e\u0635\u06cc \u0648\u062c\u0648\u062f \u0646\u062f\u0627\u0631\u062f.</div>';b.className='status ok'}catch(e){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}

async function loadAdIntelligence(){const b=document.getElementById('adIntelligenceBody');if(!b)return;try{const d=await api('/api/ads/intelligence'),m=d.metrics||{};b.innerHTML='<div class="two"><div><div class="stat">'+esc(m.hot||0)+'</div><div class="muted">\u0644\u06cc\u062f\u0647\u0627\u06cc \u062f\u0627\u063a</div></div><div><div class="stat">'+esc(m.opportunities||0)+'</div><div class="muted">\u0641\u0631\u0635\u062a \u062a\u0628\u0644\u06cc\u063a</div></div><div><div class="stat">'+esc(m.action_items||0)+'</div><div class="muted">\u0627\u0642\u062f\u0627\u0645 \u0628\u0639\u062f\u06cc</div></div><div><div class="stat">'+esc(m.duplicate_domains||0)+'</div><div class="muted">\u062f\u0627\u0645\u06cc\u0646 \u062a\u06a9\u0631\u0627\u0631\u06cc</div></div></div><div class="mini" style="margin-top:10px">\u06a9\u0644 Lead: '+esc(m.total||0)+' \u00b7 \u0641\u0639\u0627\u0644: '+esc(m.active||0)+'</div>';const list=document.getElementById('adActionList');if(list)list.innerHTML=(d.action_items||[]).slice(0,10).map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'\u0628\u062f\u0648\u0646 \u0646\u0627\u0645')+'</b><span class="pill">'+esc(x.score||0)+'</span></div><div class="mini">'+esc(x.type||'')+' \u00b7 '+esc(x.stage||'')+'</div><div class="mini">'+esc(x.action||'')+'</div><div class="mini">'+esc((x.factors||[]).join(' \u00b7 '))+'</div></div>').join('')||'<div class="empty">\u0627\u0642\u062f\u0627\u0645 \u0641\u0648\u0631\u06cc \u062b\u0628\u062a \u0646\u0634\u062f\u0647.</div>';b.className='status ok'}catch(e){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}
async function runAdFollowups(){const b=document.getElementById('adFollowupStatus');if(b){b.className='status';b.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0622\u0645\u0627\u062f\u0647\u200c\u0633\u0627\u0632\u06cc \u067e\u06cc\u06af\u06cc\u0631\u06cc\u200c\u0647\u0627\u06cc \u0633\u0631\u0631\u0633\u06cc\u062f\u2026'}try{const d=await api('/api/ads/followups/run',{method:'POST',body:'{}'});if(b){b.className='status ok';b.textContent='\u2705 '+esc(d.prepared||0)+' \u067e\u06cc\u06af\u06cc\u0631\u06cc \u0622\u0645\u0627\u062f\u0647 \u0634\u062f \u00b7 '+esc(d.skipped||0)+' \u0645\u0648\u0631\u062f \u0631\u062f \u0634\u062f.'}await loadAdOverview();await loadAdAutopilotStatus()}catch(e){if(b){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}}

async function runAdAutopilot(){const st=document.getElementById('adsStatus'),list=document.getElementById('adsList');if(!st||!list)return;const city=document.getElementById('adsCity').value.trim(),type=document.getElementById('adsType').value,extra=document.getElementById('adsExtra').value.trim();st.className='status';st.textContent='\u{1f916} \u062e\u0644\u0628\u0627\u0646 \u062e\u0648\u062f\u06a9\u0627\u0631 \u062f\u0631 \u062d\u0627\u0644 \u0628\u0631\u0631\u0633\u06cc \u0622\u0645\u0627\u062f\u06af\u06cc \u0648 \u0633\u067e\u0633 \u0627\u062c\u0631\u0627\u06cc \u0639\u0645\u0644\u06cc\u0627\u062a \u0627\u0633\u062a\u2026';list.innerHTML='';try{const pf=await api('/api/ads/preflight');const failed=(pf.checks||[]).filter(x=>x.status==='FAIL');if(failed.length){throw Error('Preflight \u0646\u0627\u0645\u0648\u0641\u0642 \u0627\u0633\u062a: '+failed.map(x=>x.name+': '+(x.details||x.value||'FAIL')).join(' \u00b7 '))}if(pf.safe!==true){throw Error('Preflight \u0627\u062c\u0627\u0632\u0647 \u0627\u062c\u0631\u0627\u06cc Autopilot \u0631\u0627 \u0635\u0627\u062f\u0631 \u0646\u06a9\u0631\u062f.')}const d=await api('/api/ads/autopilot',{method:'POST',body:JSON.stringify({city,type,extra})});const m=d.summary||{};st.className='status ok';st.textContent='\u2705 \u062e\u0644\u0628\u0627\u0646 \u062e\u0648\u062f\u06a9\u0627\u0631 \u062a\u0645\u0627\u0645 \u0634\u062f \u00b7 '+(m.found||0)+' \u067e\u06cc\u062f\u0627 \u0634\u062f \u00b7 '+(m.new_leads||0)+' \u062c\u062f\u06cc\u062f \u00b7 '+(m.drafted||0)+' \u0645\u0630\u0627\u06a9\u0631\u0647 \u0622\u0645\u0627\u062f\u0647 \u0634\u062f';list.innerHTML=(d.items||[]).slice(0,20).map(x=>'<div class="item"><div class="itemhead"><b>'+esc(x.name||'\u0628\u062f\u0648\u0646 \u0646\u0627\u0645')+'</b><span class="pill">'+esc(x.score||0)+'</span></div><div class="mini">'+esc(x.type||'')+' \u00b7 '+esc(x.url||'')+'</div>'+(x.contact_url?'<div class="mini">\u0631\u0627\u0647 \u062a\u0645\u0627\u0633: '+esc(x.contact_url)+'</div>':'')+(x.draft?'<div class="text" style="margin-top:6px">'+esc(x.draft)+'</div>':'')+'</div>').join('')||'<div class="empty">\u0645\u0648\u0631\u062f \u062c\u062f\u06cc\u062f\u06cc \u067e\u06cc\u062f\u0627 \u0646\u0634\u062f.</div>';await loadAdTargets();await loadAdAutopilotStatus()}catch(e){st.className='status error';st.textContent='\u062e\u0637\u0627: '+e.message}}
async function loadAdPreflight(){const b=document.getElementById('adPreflight');if(!b)return;b.className='status';b.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0628\u0631\u0631\u0633\u06cc \u0622\u0645\u0627\u062f\u06af\u06cc \u0633\u06cc\u0633\u062a\u0645\u2026';try{const d=await api('/api/ads/preflight');const bad=(d.checks||[]).filter(x=>x.status==='FAIL');b.innerHTML=(d.checks||[]).map(x=>'<div class="mini">'+(x.status==='PASS'?'\u{1f7e2}':x.status==='READY'?'\u{1f7e1}':x.status==='SKIP'?'\u26aa':'\u{1f534}')+' '+esc(x.name)+': '+esc(x.details||x.value||x.status)+'</div>').join('');b.className=bad.length?'status error':'status ok'}catch(e){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}
async function loadAdAutopilotStatus(){const b=document.getElementById('adAutopilotStatus');if(!b)return;try{const d=await api('/api/ads/autopilot/status'),m=d.metrics||{};b.innerHTML='<div class="stat">'+(d.enabled?'\u{1f7e2} ON':'\u{1f534} OFF')+'</div><div class="mini">'+(d.enabled?'\u0627\u062c\u0631\u0627\u06cc \u062e\u0648\u062f\u06a9\u0627\u0631 \u0647\u0631 \u06f1\u06f5 \u062f\u0642\u06cc\u0642\u0647 \u0641\u0639\u0627\u0644 \u0627\u0633\u062a':'\u0627\u062c\u0631\u0627\u06cc \u062e\u0648\u062f\u06a9\u0627\u0631 \u0645\u062a\u0648\u0642\u0641 \u0627\u0633\u062a')+' \u00b7 '+esc(m.ad_targets||0)+' \u0647\u062f\u0641 \u062a\u0628\u0644\u06cc\u063a\u0627\u062a\u06cc \u00b7 '+esc(m.hot||0)+' \u062f\u0627\u063a \u00b7 '+esc(m.negotiation||0)+' \u0645\u0630\u0627\u06a9\u0631\u0647 \u00b7 '+esc(m.followups||0)+' \u067e\u06cc\u06af\u06cc\u0631\u06cc \u00b7 '+esc(m.customers||0)+' \u0645\u0634\u062a\u0631\u06cc</div>';b.className=d.enabled?'status ok':'status'}catch(e){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}async function startAdAutopilot(){const type=document.getElementById('adsType')?.value||'all',city=document.getElementById('adsCity')?.value.trim()||'',extra=document.getElementById('adsExtra')?.value.trim()||'',b=document.getElementById('adAutopilotControlStatus');if(b){b.className='status';b.textContent='\u062f\u0631 \u062d\u0627\u0644 \u0631\u0648\u0634\u0646\u200c\u06a9\u0631\u062f\u0646 \u062e\u0644\u0628\u0627\u0646 \u062e\u0648\u062f\u06a9\u0627\u0631\u2026'}try{const d=await api('/api/ads/autopilot/start',{method:'POST',body:JSON.stringify({type,city,extra})});if(b){b.className=d.enabled?'status ok':'status error';b.textContent=d.enabled?'\u{1f7e2} AUTOPILOT \u0631\u0648\u0634\u0646 \u0634\u062f \u0648 \u062a\u0627 STOP \u0627\u062f\u0627\u0645\u0647 \u0645\u06cc\u200c\u062f\u0647\u062f.':'\u{1f534} AUTOPILOT \u0631\u0648\u0634\u0646 \u0646\u0634\u062f.'}await loadAdAutopilotStatus();await loadAdOverview()}catch(e){if(b){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}}
async function stopAdAutopilot(){const b=document.getElementById('adAutopilotControlStatus');if(b){b.className='status';b.textContent='\u062f\u0631 \u062d\u0627\u0644 \u062e\u0627\u0645\u0648\u0634\u200c\u06a9\u0631\u062f\u0646 \u062e\u0644\u0628\u0627\u0646 \u062e\u0648\u062f\u06a9\u0627\u0631\u2026'}try{await api('/api/ads/autopilot/stop',{method:'POST',body:'{}'});if(b){b.className='status ok';b.textContent='\u23f9\ufe0f AUTOPILOT \u062e\u0627\u0645\u0648\u0634 \u0634\u062f. \u0627\u062c\u0631\u0627\u06cc \u0632\u0645\u0627\u0646\u200c\u0628\u0646\u062f\u06cc\u200c\u0634\u062f\u0647 \u0645\u062a\u0648\u0642\u0641 \u0627\u0633\u062a.'}await loadAdAutopilotStatus()}catch(e){if(b){b.className='status error';b.textContent='\u062e\u0637\u0627: '+e.message}}}
